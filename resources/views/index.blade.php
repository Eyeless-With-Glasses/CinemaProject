                        ...
                        <li>
                            <div class="movie-card">
                                ...
                                <div class="title-wrapper">
                                    ...
                                    <time datetime="2022">{{$film->year}}</time>
                                </div>
                                <div class="card-meta">
                                    <div class="badge badge-outline">HD</div>
                                    <div class="duration">
                                        ...
                                        <time datetime="PT137M">{{$film->time}}</time>
                                    </div>
                                    <div class="rating">
                                ...
                                <div class="movie-card">
                                    ...
                                    <div class="card-meta">
                                        ...
                                        <div class="duration">
                                            ...
                                            <time datetime="PT122M">{{$film->time}}</time>
                                        </div>
...
<footer class="footer">
        ...
        <div class="container">
            ...
            <div class="footer-brand-wrapper">
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        <a href="{{route('home.index')}}" class="footer-link">Home</a>
                    </li>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <img src="images/footer-bottom-img.png" alt="Online banking companies logo"
